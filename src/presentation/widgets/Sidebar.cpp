    ...
    : QWidget(parent)
{
    ...
    connect(flashCardsButton,&QPushButton::clicked, this, &Sidebar::flashCardsClicked);
    connect(settingsButton,  &QPushButton::clicked, this, &Sidebar::settingsClicked);

    // Re-emit topics signals so MainWindow only talks to Sidebar
    connect(topicsPanel, &TopicsPanel::topicSelected,
            this, &Sidebar::topicSelected);
    connect(topicsPanel, &TopicsPanel::noteSelected,
