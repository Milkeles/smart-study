...
FlashCardEditorWidget::FlashCardEditorWidget(
      ...
      manager(manager)
{
    ...
    connect(startBtn, &QPushButton::clicked, this, &FlashCardEditorWidget::onStart);
    ...
    connect(setSelector, &QComboBox::currentTextChanged, this, [this](const QString &setName){
...
void FlashCardEditorWidget::onSave()
{
    ...
    if (setName == "Create new set...") {
        bool ok;
        setName = QInputDialog::getText(this, "Create New Flashcard Set",
                                        "Enter set name:", QLineEdit::Normal,
                                        "", &ok);
...
void FlashCardEditorWidget::onStart() {
    emit startFlashcardsRequested();
}
