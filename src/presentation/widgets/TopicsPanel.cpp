...
void TopicsPanel::createMockData() {
  addTopic("Quantum Computing", {"Superposition", "Grover's search algorithm",
                                 "Tonsors", "Entanglement"});
...
void TopicsPanel::addTopic(const QString &name, const QStringList &notes,
                           bool expanded) {
